...
plot_tdc_mat <- function(data, title, tickers = NULL, percentile = 0.05,
  ...
  # Set the upper triangle (including the diagonal if desired) to NA so that only the lower triangle is plotted.
...
Spearman_stable_comm <-plot_spearman_correlation_ggplot(garch_communication_stable_wide, "Spearman Correlation for Communication Services (Stable Period)", communication_tickers)
Spearman_pan_comm <-plot_spearman_correlation_ggplot(garch_communication_pandemic_wide, "Spearman Correlation for Communication Services (Pandemic Period)", communication_tickers)
...
tdc_stable_comm <-plot_tdc_mat(garch_communication_stable_wide, "TDC for Communication Services (Stable Period)",tickers =  communication_tickers, percentile = 0.05)
tdc_pan_comm <-plot_tdc_mat(garch_communication_pandemic_wide, "TDC for Communication Services (Pandemic Period)",tickers =  communication_tickers, percentile = 0.05)
...
Spearman_stable_dis <-plot_spearman_correlation_ggplot(garch_discretionary_stable_wide, "Spearman Correlation for Consumer Discretionary (Stable Period)", discretionary_tickers)
Spearman_pan_dis <-plot_spearman_correlation_ggplot(garch_discretionary_pandemic_wide, "Spearman Correlation for Consumer Discretionary (Pandemic Period)", discretionary_tickers)

mutualinfo_stable_dis <-plot_mutual_information_matrix(garch_discretionary_stable_wide, "Mutual Information for Consumer Discretionary (Stable Period)", discretionary_tickers)
mutualinfo_pan_dis <-plot_mutual_information_matrix(garch_discretionary_pandemic_wide, "Mutual Information for Consumer Discretionary (Pandemic Period)", discretionary_tickers)

tdc_stable_dis <-plot_tdc_mat(garch_discretionary_stable_wide, "TDC for Consumer Discretionary (Stable Period)",tickers =  discretionary_tickers, percentile = 0.05)
tdc_pan_dis <-plot_tdc_mat(garch_discretionary_pandemic_wide, "TDC for Consumer Discretionary (Pandemic Period)",tickers =  discretionary_tickers, percentile = 0.05)
...
Spearman_stable_con <-plot_spearman_correlation_ggplot(garch_staples_stable_wide, "Spearman Correlation for Consumer Staples (Stable Period)", staples_tickers)
Spearman_pan_con <-plot_spearman_correlation_ggplot(garch_staples_pandemic_wide, "Spearman Correlation for Consumer Staples (Pandemic Period)", staples_tickers)
...
tdc_stable_con <-plot_tdc_mat(garch_staples_stable_wide, "TDC for Consumer Staples (Stable Period)",tickers =  staples_tickers, percentile = 0.05)
tdc_pan_con <-plot_tdc_mat(garch_staples_pandemic_wide, "TDC for Consumer Staples (Pandemic Period)",tickers = staples_tickers, percentile = 0.05)
...
plot_tdc_mat_all_sector <- function(data, title, tickers, percentile = 0.05, show_lower_triangle = FALSE) {
  # Compute TDC matrix
  tdc_mat <- compute_tdc_matrix(data, percentile = percentile)
  ...
  # Ensure the full matrix is shown
...
all_spearman_pan <-plot_spearman_correlation_ggplot_all_sector(all_sector_wide_pandemic, "Spearman Correlation for Across All Sectors (Pandemic Period)", all_tickers)
